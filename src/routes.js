...
app.post('/user/:userId/transactions/:typeTransaction/', async (req, res) => {
    try {
        ...
        if (req.params.typeTransaction === 'earnings'){
            const earningsArray = typeof user.financeInfo.earnings === 'array' ?  user.financeInfo.earnings :  []
            ...
            const expensesArray = typeof user.financeInfo.expenses === 'array' ?  user.financeInfo.expenses :  []
